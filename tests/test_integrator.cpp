...
TEST_F(IntegratorTest, DiffusionElementMatrix) {
    ...
    DiffusionIntegrator integ(k1_.get());
...
TEST_F(IntegratorTest, DiffusionMatrixScaling) {
    ...
    DiffusionIntegrator integ1(k1_.get());
    DiffusionIntegrator integ2(k2_.get());
...
TEST_F(IntegratorTest, AnisotropicDiffusion) {
    ...
    AnisotropicDiffusionIntegrator integ(matCoef.get());
...
TEST_F(IntegratorTest, BilinearFormAssembler) {
    ...
    assembler.addDomainIntegrator(std::make_unique<DiffusionIntegrator>(k1_.get()));
    assembler.assemble();
