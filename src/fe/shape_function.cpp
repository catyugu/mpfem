...
namespace mpfem {
    ...
    void H1SegmentShape::evalValues(const Vector3& xi, std::span<Real> values) const
    {
        const Real x = xi.x();
        if (order_ == 1) {
    ...
    void H1SegmentShape::evalGrads(const Vector3& xi, std::span<Vector3> grads) const
    {
        const Real x = xi.x();
        if (order_ == 1) {
    ...
    void H1TriangleShape::evalValues(const Vector3& xi, std::span<Real> values) const
    {
        const Real xi1 = xi.x();
        const Real xi2 = xi.y();
    ...
    void H1TriangleShape::evalGrads(const Vector3& xi, std::span<Vector3> grads) const
    {
        const Real xi1 = xi.x();
        const Real xi2 = xi.y();
    ...
    std::vector<Vector3> H1TriangleShape::dofCoords() const
    {
        if (order_ == 1) {
            ...
            return {
                Vector3(0.0, 0.0, 0.0), Vector3(1.0, 0.0, 0.0), Vector3(0.0, 1.0, 0.0), // vertices
                Vector3(0.5, 0.0, 0.0), Vector3(0.0, 0.5, 0.0), Vector3(0.5, 0.5, 0.0) // edge midpoints: E01, E20, E12
            };
        }
    }
    ...
    void H1SquareShape::evalValues(const Vector3& xi, std::span<Real> values) const
    {
        const Real x = xi.x();
        const Real y = xi.y();
    ...
    void H1SquareShape::evalGrads(const Vector3& xi, std::span<Vector3> grads) const
    {
        const Real x = xi.x();
        const Real y = xi.y();
    ...
    std::vector<Vector3> H1SquareShape::dofCoords() const
    {
        if (order_ == 1) {
            ...
            return {
                Vector3(-1.0, -1.0, 0.0), Vector3(1.0, -1.0, 0.0), Vector3(1.0, 1.0, 0.0), Vector3(-1.0, 1.0, 0.0), // corners
                Vector3(0.0, -1.0, 0.0), Vector3(1.0, 0.0, 0.0), Vector3(0.0, 1.0, 0.0), Vector3(-1.0, 0.0, 0.0), // edges
    ...
    void H1TetrahedronShape::evalValues(const Vector3& xi, std::span<Real> values) const
    {
        const Real xi1 = xi.x();
        const Real xi2 = xi.y();
        const Real xi3 = xi.z();
    ...
    void H1TetrahedronShape::evalGrads(const Vector3& xi, std::span<Vector3> grads) const
    {
        const Real xi1 = xi.x();
        const Real xi2 = xi.y();
        const Real xi3 = xi.z();
    ...
    std::vector<Vector3> H1TetrahedronShape::dofCoords() const
    {
        if (order_ == 1) {
            ...
            return {
                Vector3(0.0, 0.0, 0.0), Vector3(1.0, 0.0, 0.0), Vector3(0.0, 1.0, 0.0), Vector3(0.0, 0.0, 1.0), // vertices
                Vector3(0.5, 0.0, 0.0), Vector3(0.0, 0.5, 0.0), Vector3(0.5, 0.5, 0.0), // edges on z=0
                Vector3(0.0, 0.0, 0.5), Vector3(0.5, 0.0, 0.5), Vector3(0.0, 0.5, 0.5) // edges to z
            };
        }
    }
    ...
    void H1CubeShape::evalValues(const Vector3& xi, std::span<Real> values) const
    {
        const Real x = xi.x();
        const Real y = xi.y();
        const Real z = xi.z();
    ...
    void H1CubeShape::evalGrads(const Vector3& xi, std::span<Vector3> grads) const
    {
        const Real x = xi.x();
        const Real y = xi.y();
        const Real z = xi.z();
