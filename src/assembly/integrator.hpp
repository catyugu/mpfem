...
namespace mpfem {
    ...
    class FacetBilinearIntegratorBase {
    public:
        virtual ~FacetBilinearIntegratorBase() = default;
        virtual void assembleFacetMatrix(const ReferenceElement& ref,
            ElementTransform& trans,
            Matrix& elmat) const
            = 0;
    };
    ...
    class FacetLinearIntegratorBase {
    public:
        virtual ~FacetLinearIntegratorBase() = default;
        virtual void assembleFacetVector(const ReferenceElement& ref,
            ElementTransform& trans,
            Vector& elvec) const
            = 0;
    };
