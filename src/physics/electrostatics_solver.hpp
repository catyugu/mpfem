...
namespace mpfem
{
    ...
    public:
                        ...
                        const PWConstCoefficient &conductivity) override
        {
            ...
            conductivity_ = std::make_shared<PWConstCoefficient>(conductivity);
        ...
        void assemble() override
        {
            ...
            auto diffInteg = std::make_unique<DiffusionIntegrator>(conductivity_);
        ...
        const Coefficient *conductivity() const
        {
            return conductivity_.get();
        }
        ...
        /**
         * @brief Use temperature-dependent conductivity coefficient.
         * Replaces the internal conductivity with a temperature-dependent one.
         * @param tempDepCoeff Temperature-dependent conductivity coefficient
         */
        void setTemperatureDependentConductivity(
            std::unique_ptr<TemperatureDependentConductivityCoefficient> tempDepCoeff)
        {
            // Store as TemperatureDependentConductivityCoefficient for setTemperatureField access
            tempDependentConductivity_ = tempDepCoeff.get();
            // Transfer ownership to conductivity_ (base class pointer)
            conductivity_ = std::move(tempDepCoeff);
        }
        
        /**
         * @brief Get the temperature-dependent conductivity coefficient.
         */
        TemperatureDependentConductivityCoefficient* temperatureDependentConductivity() {
            return tempDependentConductivity_;
        }
    ...
    private:
        ...
        std::shared_ptr<Coefficient> conductivity_;  // Base class for both PWConst and TempDep
        ...
        TemperatureDependentConductivityCoefficient* tempDependentConductivity_ = nullptr;  // Non-owning, points to conductivity_ if temp-dep
    };
